...
namespace HW2.Tests
{
    ...
    public class TerminatorTests
    {
        ...
        {
            Shape shape = new Terminator("Terminator", "test", 0, 100, 200, 300, 400);
        ...
        public void DrawTest()
        {
            ...
            shape = new Terminator("Terminator", "test", 0, 100, 200, 0, 0);
            shape.Draw(mockGraphic);
        }
        ...
        {
            Shape shape = new Process("Terminator", "test", 0, 100, 200, 300, 400);
